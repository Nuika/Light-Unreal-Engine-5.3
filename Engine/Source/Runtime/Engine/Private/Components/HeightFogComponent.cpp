	...
	: Super(ObjectInitializer)
{
	...
	DirectionalInscatteringLightDirection = FVector(1.0f, 0.0f, 0.0f);  // Example default value
}
...
//Custom Goober function for setting the inscattering light direction.
void UExponentialHeightFogComponent::SetDirectionalInscatteringLightDirection(const FVector Value)
{
	if(DirectionalInscatteringLightDirection != Value)
	{
		DirectionalInscatteringLightDirection = Value;
		MarkRenderStateDirty();
	}
}
