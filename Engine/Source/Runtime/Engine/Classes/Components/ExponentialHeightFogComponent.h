...
class UExponentialHeightFogComponent : public USceneComponent
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = DirectionalInscattering)
...
public:
	...
	// Custom Goober function for setting the light direction.
	UFUNCTION(BlueprintCallable, Category = "Rendering|Components|ExponentialHeightFog")
	ENGINE_API void SetDirectionalInscatteringLightDirection(const FVector Value);
